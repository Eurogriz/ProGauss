...
ELEMENTS: tuple[Element, ...] = (
    Element(1, "H", "Водород", 0.31, 1),
    Element(5, "B", "Бор", 0.84, 3),
    Element(6, "C", "Углерод", 0.76, 4),
    Element(7, "N", "Азот", 0.71, 3),
    Element(8, "O", "Кислород", 0.66, 2),
    Element(9, "F", "Фтор", 0.57, 1),
    Element(14, "Si", "Кремний", 1.11, 4),
    Element(15, "P", "Фосфор", 1.07, 3),
    Element(16, "S", "Сера", 1.05, 2),
    Element(17, "Cl", "Хлор", 1.02, 1),
    Element(35, "Br", "Бром", 1.20, 1),
    Element(53, "I", "Иод", 1.39, 1),
)
